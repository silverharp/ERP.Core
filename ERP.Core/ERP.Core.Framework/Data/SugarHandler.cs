...
namespace ERP.Framework.Data
{
    ...
    public class SugarRepository : ISugarHandler
    {
        ...
        public SugarRepository() {
            //AppsettingHelper.GetSection()
            Instance("localhost", "root", "", "erp.core", SqlSugar.DbType.MySql);
        }
        ...
        /// <returns>值</returns>
        public void Instance(string serverIp, string user, string pass, string dataBase, SqlSugar.DbType dbType)
        {
            BaseDbContext.SetConn(serverIp, user, pass, dataBase, dbType);
            DbContext = BaseDbContext.Instance;
        }
